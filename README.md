...
git clone https://github.com/Joakim-animate90/go-crafted-backend.git
...
### API documentation of Go Crafted Backend

<a href="https://documenter.getpostman.com/view/391588/2s8Z75S9xy" target="_blank">
    <img alt="View API Doc Button" src="https://github.com/Joakim-animate90/go-crafted-backend/blob/main/assets/button-view-api-docs.png?raw=true" width="200" height="60"/>
</a>
...
### Contributing to Go Crafted Backend
